...
<div class="main__content settings">
    ...
    <script language="javascript" type="text/javascript"><!--
        ...
        {
            window.open('admin_settings_misc.php?rebuild_prod_assets&token=<?php echo rawurlencode(hesk_token_echo(0)); ?>',"Hesk_window","height=400,width=500,menubar=0,location=0,toolbar=0,status=0,resizable=1,scrollbars=1");
            return false;
        }

        function hesk_purgeCache()
        {
            window.open('admin_settings_misc.php?purge_cache&token=<?php echo rawurlencode(hesk_token_echo(0)); ?>',"Hesk_window","height=400,width=500,menubar=0,location=0,toolbar=0,status=0,resizable=1,scrollbars=1");
            return false;
        }
        //-->
    </script>
...
function hesk_rebuildProdAssets() {
    ...
    <p>&nbsp;</p>
    <p align="center"><a href="admin_settings_misc.php?rebuild_prod_assets&amp;<?php echo rand(10000,99999); ?>&amp;token=<?php echo rawurlencode(hesk_token_echo(0)); ?>"><?php echo $hesklang['rebuild_again']; ?></a> | <a href="#" onclick="Javascript:window.close()"><?php echo $hesklang['cwin']; ?></a></p>
    <p>&nbsp;</p>
    </body>
    </html>
    <?php
